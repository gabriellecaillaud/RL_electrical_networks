...
def save_results(folder, model, g):
...
# sw_fromRL = ReconfigAction_fromRL # The received data should be organized as a dictionary, see how sw_init is defined below
...
# ------------------------- Save results ---------------------------------
save_results(folder, model, g) # Save results of the experiment in a directory
