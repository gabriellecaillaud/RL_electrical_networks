...
class env():
    ...
    def response(self,envir,ReconfAction_fromRL,RepairAction_fromRL=None):
        # ***** small use case *****
        ...
        # ------------------------- Save results ---------------------------------
        envir.save_results(folder, model, g) # Save results of the experiment in a directory
        ...
        envir.next_state = result + result_p_ns
        envir.reward = p_ns[2] - p_ns[1]
        envir.graph = g
        envir.model = model
